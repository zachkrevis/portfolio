...
import {FaJava, FaPython, FaCode, FaJsSquare, FaReact, FaSass, FaNodeJs, FaDatabase, FaLaptopCode, FaLightbulb, FaCloud } from 'react-icons/fa';
        ...
        <div className='Skills'>
            ...
            <div className='Block'>
                ...
                <ul className="skillList">
                    ...
                    <li><FaCloud style={{ fill: "url(#main)" }} className='SkillIcon'/> OOP with Web-Based Application</li>
